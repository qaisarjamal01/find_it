...
import 'categories/Found/found_items.dart';
import 'categories/Item details/item_details.dart';
import 'categories/Lost/lost_items.dart';
import 'categories/MobilesCategory/mobile_screen.dart';
import 'categories/OthersCategory/other_screen.dart';
import 'categories/WatchesCategory/watches_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Lost And Found Items',style: TextStyle(color: Color(0xffFFFFFF)),),
                ...
                child: Row(
                  children: [
                    TextButton(
                        ...
                        child: Text('All data',style: TextStyle(color: Color(0xffFFA500),fontSize: 0.26.dp,fontWeight: FontWeight.bold),)),
                    TextButton(
                        onPressed: (){
                           Navigator.push(context, MaterialPageRoute(builder: (_)=>MobileScreen()));
                        },
                        child: Text('Mobiles',style: TextStyle(color: Color(0xffFFA500),fontSize: 0.26.dp,fontWeight: FontWeight.bold),)),

                    TextButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (_)=>BagScreen()));
                        },
                        child: Text('Hand Bags',style: TextStyle(color: Color(0xffFFA500),fontWeight: FontWeight.bold,fontSize: 0.26.dp),)),
                    TextButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (_)=> WatchesScreen()));
                        },
                        child: Text('Watches',style: TextStyle(color: Color(0xffFFA500),fontSize: 0.26.dp,fontWeight:FontWeight.bold),)),
                    TextButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (_)=> OtherScreen()));
                        },
                        child: Text('Others',style: TextStyle(color: Color(0xffFFA500),fontSize: 0.26.dp,fontWeight:FontWeight.bold),)),
                  ],
                ),
    ),
          Row(
            children: [
              TextButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (_)=>LostItems()));
                  },
                  child: Text('Lost',style: TextStyle(color: Color(0xffFFA500),fontSize: 0.26.dp,fontWeight: FontWeight.bold),)),
              TextButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (_)=>FoundItems()));
                  },
                  child: Text('Found',style: TextStyle(color: Color(0xffFFA500),fontSize: 0.26.dp,fontWeight: FontWeight.bold),)),
            ],
          ),
          Padding(
            padding: EdgeInsets.only(top: 1.8.h,left: 3.w),
